...
p2_b <-ggplot(aes(y = volatile.acidity, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + ggtitle('Volatile acidity')
...
p4_b <-ggplot(aes(y = residual.sugar, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + coord_trans(y='log10') + ggtitle('Residual sugar') #transformed y
...
p5_b <-ggplot(aes(y = chlorides, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + coord_trans(y='log10') + ggtitle('Chlorides') #transformed y
...
p6_b <-ggplot(aes(y = free.sulfur.dioxide, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + coord_trans(y='log10') + ggtitle('Free sulfur dioxide') #transformed y
...
p7_b <-ggplot(aes(y = total.sulfur.dioxide, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + coord_trans(y='log10')  + ggtitle('Total sulfur dioxide') #transformed y
...
```{r echo=FALSE, Univariate_Plots_density, fig.width=8, fig.height=8}
#Density
...
p8_b <-ggplot(aes(y = density, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + coord_trans(y='log10') + ggtitle('Density')#transformed y
...
p9_b <-ggplot(aes(y = pH, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + coord_trans(y='log10') + ggtitle('pH')  #transformed y
...
p10_b <-ggplot(aes(y = sulphates, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + coord_trans(y='log10')  + ggtitle('Sulphates')#transformed y
...
p11_b <-ggplot(aes(y = alcohol, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + coord_trans(y='log10')  + ggtitle('Alcohol')#transformed y
