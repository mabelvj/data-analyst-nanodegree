...
lm1 <- plot_linear_model(x='quality', y = 'sulphates')

#lm2

lm2 <- plot_linear_model(x='quality', y = 'pH') 

#lm3

lm3 <- plot_linear_model(x='quality', y = 'total.sulfur.dioxide')


# arrange the three plots in a single row
p_ <- grid.arrange(lm1,lm2,lm3, ncol=3)
p_
```
...
```{r lm, fig.width=12,fig.asp=0.33}
##ggplot(aes(x = quality, y = free.sulfur.dioxide), data = redwines) + geom_point(aes(color=quality.cat),alpha=1/4, position = 'jitter')+ ggtitle(' Free SO2 and  Quality Relationship')
