...
In the next figure (fig.\@ref(fig:MultivariateCorrelation)) it is shown the correlation factor between the different variables in the Red Wines dataset. Significant correlation values ($|R|>0.3$) are highlighted with stronger color density the higher the correlation value.
...
For the three main variables influencing the quality of wine:
...
```{r lm_quality, fig.width=12,fig.asp=0.33,  fig.align= 'center', fig.cap=  " Sulphates, pH and total sulfur dioxide vs quality"}
...
```{r bivariateq1_1, fig.width=6, fig.asp=0.5, fig.align= 'center', fig.cap= "Density and pH vs fixed acidity"}
