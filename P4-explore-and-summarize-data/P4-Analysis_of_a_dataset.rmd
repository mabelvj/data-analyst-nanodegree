---
title: 'Project 2 : Explartion of Red Wine Quality'
...
library(gridExtra)
#Fixed
p1 <- ggplot(aes(x = fixed.acidity), data = redwines) + geom_histogram(binwidth=.5, color = "black") + ggtitle('Fixed acidity') +  theme_light(base_size = 10) # +  scale_x_log10() #+

# Volatile
p2 <-ggplot(aes(x = volatile.acidity), data = redwines) + geom_histogram(binwidth = .05,  color = "black")+  scale_x_log10() + ggtitle('Volatile acidity')  + theme_light(base_size = 10)

# Citric acid
p3 <-ggplot(aes(x = citric.acid), data = redwines) + geom_histogram(binwidth = .05,  color = "black") + ggtitle('Citric acidity') + theme_light(base_size = 10)
...
#Residual sugar
p4 <- ggplot(aes(x = residual.sugar), data = redwines) + geom_histogram(binwidth=.1,  color = "black") +  scale_x_log10() + ggtitle('Residual sugar')  + theme_light(base_size = 10)
...
#Chlorides
p5 <- ggplot(aes(x = chlorides), data = redwines) + geom_histogram(binwidth=.1,  color = "black") +  scale_x_log10() + ggtitle('Chlorides')+ theme_light(base_size = 10)

#Free sulfur dioxide
p6 <- ggplot(aes(x = free.sulfur.dioxide), data = redwines) + geom_histogram(binwidth=.1,  color = "black") +  scale_x_log10() + ggtitle('Free sulfur dioxide') + theme_light(base_size = 10)

#Total sulfur dioxide
p7 <- ggplot(aes(x = total.sulfur.dioxide), data = redwines) + geom_histogram(binwidth=.1,  color = "black") +  scale_x_log10() + ggtitle('Total sulfur dioxide') + theme_light(base_size = 10)
...
#Density
p8 <- ggplot(aes(x = density), data = redwines) + geom_histogram(binwidth=.0005,  color = "black") +  scale_x_log10() + ggtitle('Density')+ theme_light(base_size = 10)

#pH
p9 <- ggplot(aes(x = pH), data = redwines) + geom_histogram(binwidth=.01, color = "black") +  scale_x_log10() + ggtitle('pH') + theme_light(base_size = 10)

#Sulphates
p10 <- ggplot(aes(x = sulphates), data = redwines) + geom_histogram(binwidth=.05,  color = "black") +  scale_x_log10() + ggtitle('Sulphates')+ theme_light(base_size = 10) 

#Alcohol
p11 <- ggplot(aes(x = alcohol), data = redwines) + geom_histogram(binwidth=.01, color = "black") +  scale_x_log10() + ggtitle('Alcohol')+ theme_light(base_size = 10)
...
```{r echo=FALSE, Bivariate_Plots_acidity,fig.width=8, fig.height=6}
library(gridExtra)
#Fixed
...
p1_b <-ggplot(aes(y = fixed.acidity, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + ggtitle('Fixed acidity') +  theme_light(base_size = 10)
...
p2_b <-ggplot(aes(y = volatile.acidity, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + ggtitle('Volatile acidity') +  scale_y_log10() +  theme_light(base_size = 10)
...
p3_b <-ggplot(aes(y = citric.acid, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + ggtitle('Citric acidity') +  theme_light(base_size = 10)
...
p4_b <-ggplot(aes(y = residual.sugar, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + scale_y_log10() + ggtitle('Residual sugar') +  theme_light(base_size = 10) #transformed y
...
p5_b <-ggplot(aes(y = chlorides, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + scale_y_log10() + ggtitle('Chlorides') + theme_light(base_size = 10)#transformed y
...
p6_b <-ggplot(aes(y = free.sulfur.dioxide, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + scale_y_log10() + ggtitle('Free sulfur dioxide') +  theme_light(base_size = 10) #transformed y
...
p7_b <-ggplot(aes(y = total.sulfur.dioxide, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + scale_y_log10() + ggtitle('Total sulfur dioxide') +  theme_light(base_size = 10)#transformed y
...
p8_b <-ggplot(aes(y = density, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + scale_y_log10() + ggtitle('Density')+  theme_light(base_size = 10)#transformed y
...
p9_b <-ggplot(aes(y = pH, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + scale_y_log10() + ggtitle('pH')+ theme_light(base_size = 10)#transformed y
...
p10_b <-ggplot(aes(y = sulphates, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + scale_y_log10() + ggtitle('Sulphates')+  theme_light(base_size = 10)#transformed y
...
p11_b <-ggplot(aes(y = alcohol, x= quality.cat, color= quality.cat), data = redwines) + geom_boxplot() + scale_y_log10() + ggtitle('Alcohol') + theme_light(base_size = 10)#transformed y
