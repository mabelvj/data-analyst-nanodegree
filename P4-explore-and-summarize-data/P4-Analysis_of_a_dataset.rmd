...
```{r echo=FALSE, Univariate_Plots_acidity,fig.width=8, fig.height=6}
library(gridExtra)
#Fixed
...
```
> The quality of the wine is directly proportional to the fixed acidity and acid levels and inversely proportional to volatile acidity. 

```{r echo=FALSE, Univariate_Plots_residual_sugar,fig.width=8, fig.height=2}
#Residual sugar
...
```{r echo=FALSE, Univariate_Plots_chlorides,fig.width=8, fig.height=6}
#Chlorides
...
```{r echo=FALSE, Univariate_Plots_density, fig.width=8, fig.height=6}
#Density
...
```
```{r echo=FALSE, Univariate_Plots_1, fig.width=16, fig.height=8}
library(gridExtra)
