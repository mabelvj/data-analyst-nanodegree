...
#setwd('Git/data-analyst-nanodegree/P4/')
library(ggplot2)
...
```
> The quality is directly proportional to fixed acidity and inverselly proportional to volatile acidity. High citric acid levels are indicative of good quality. 
