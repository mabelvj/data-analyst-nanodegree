...
> The **independent variabled** are the conditions (congruent and incongruent), and the **dependent variable** is the time to name the ink color in equally-sized lits.
...
> for *c* and *i* standing, respectively, for *congruent* and *incongruent*.
